...
TanStack Router & 1.168 & Roteamento \textit{file-based} com segurança de tipos \\
TanStack Start & 1.167 & Camada \textit{full-stack} (SSR opcional) sobre o Router \\
...
Zod & 3.24 & Validação declarativa de esquemas de formulário e \textit{search params} (inferência de tipos) \\
