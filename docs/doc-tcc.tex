...
% ------------------------------
\section{Software: Implementação e Resultados Alcançados}
...
Declaro que o código-fonte do software foi entregue à coordenação do curso, sob o processo SUAP nº \rule{4cm}{0.4pt}.
...
Declaro que o software foi submetido ao Núcleo de Inovação Tecnológica (NIT) do IFPI, sob o processo SUAP nº \rule{4cm}{0.4pt}.
